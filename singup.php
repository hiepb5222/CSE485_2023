...
<body>
                ...
                <div class="card-body">
                    <form action="./register.php" method="POST">
                        ...
                        <div class="form-group">
                            <input type="submit" value="Sign Up" name="signbtn" id="btnSign"
                                class="btn fload-start btn-primary">
    ...
    <footer
        class="footer bg-white d-flex justify-content-center align-items-center border-top border-secondary  border-2"
